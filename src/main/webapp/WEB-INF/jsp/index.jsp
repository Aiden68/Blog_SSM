		...
		<div class="content">
			<section class="green-section">
				<div class="wrapper">
					...
					<a href="<%=path %>/list"><span class="icon"><i class="fa fa-file-text-o  fa-2x"></i>博客</span></a> 
						<a href="<%=path %>/image"><span class="icon"><i class="fa fa-picture-o fa-2x"></i>图册</span> </a> 
