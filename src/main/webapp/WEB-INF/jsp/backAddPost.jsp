...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
	...
	<link rel="stylesheet" type="text/css" href="<%=path %>/wangEditor/css/wangEditor.min.css">
	<link rel="stylesheet" type="text/css" href="<%=path %>/static/highlightjs/dark.css">
    <!--[if lt IE 9]>
...
<script type="text/javascript" src="<%=path %>/wangEditor/js/wangEditor.min.js"></script>
